...
####### AGGIUNGI
# Aggiungi widget comodi e come installartli (HTML BOM)
# Aggiungi come usare autorouter
# Aggiungi risorse
---

## Most Common Hotkeys
All the hotkeys can be seen in _Help > List Hotkeys_.
...
- X &rarr; new track.
- O &rarr; add footprint.
- L &rarr; toggle footprints placement lock.
